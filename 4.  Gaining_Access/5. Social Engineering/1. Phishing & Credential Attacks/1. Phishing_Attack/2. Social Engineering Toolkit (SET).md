...
<img width="1024" height="550" alt="SET" src="https://github.com/user-attachments/assets/a1454770-f9d2-487d-868a-1cb3ac3e475e" />
...
## 1. Credentials Harvester Attack Method
...
### 3. In both of our target that we send to
#### First Gmail:
````
...
## 4. Powershell Attack Victors

### 1. PowerShell Attack Vectors - Alphanumeric Shellcode Injector
...
### 2. compiling PowerShell scripts to exe
...
## 5. Infectious Media Generator - Bad usb Attack
