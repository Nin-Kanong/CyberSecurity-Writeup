...
| ---------------------- | --------------------------------------- | ---------------------------------- |
| `ip:`                  | Search for a specific IP                | `ip:8.8.8.8`                       |
| `net:`                 | Search within an IP range / subnet      | `net:192.168.1.0/24`               |
| `port:`                | Search by open port                     | `port:22`                          |
| `hostname:`            | Search by hostname                      | `hostname:example.com`             |
| `domain:`              | Search within a domain                  | `domain:example.com`               |
| `org:`                 | Search by organization name             | `org:Google`                       |
| `isp:`                 | Search by ISP                           | `isp:Comcast`                      |
| `asn:`                 | Search by Autonomous System Number      | `asn:AS15169`                      |
| `country:`             | Filter by country code                  | `country:US`                       |
| `city:`                | Filter by city                          | `city:London`                      |
| `geo:`                 | Search by coordinates (lat,lon)         | `geo:37.7749,-122.4194`            |
| `os:`                  | Search by operating system              | `os:Windows`                       |
| `product:`             | Search by software/product              | `product:Apache`                   |
| `version:`             | Search by version of software           | `product:Apache version:2.4.49`    |
| `before:`              | Show results before a date (YYYY-MM-DD) | `before:2023-01-01`                |
| `after:`               | Show results after a date (YYYY-MM-DD)  | `after:2024-01-01`                 |
| `ssl:`                 | Search by SSL certificate field         | `ssl:Google`                       |
| `ssl.cert.subject.cn:` | Search by SSL common name               | `ssl.cert.subject.cn:*.google.com` |
| `ssl.cert.issuer.cn:`  | Search by SSL issuer                    | `ssl.cert.issuer.cn:Let's Encrypt` |
| `title:`               | Search text in HTML `<title>`           | `title:"Login Page"`               |
| `http.html:`           | Search inside HTML response             | `http.html:"admin"`                |
| `http.favicon.hash:`   | Search by favicon hash                  | `http.favicon.hash:-247388890`     |
| `vuln:`                | Search by CVE identifier                | `vuln:CVE-2021-44228`              |
...
## Also we can use shodan extension:
- First type this in browser:

<img width="883" height="872" alt="image" src="https://github.com/user-attachments/assets/3cd656a2-2fa0-40fc-b979-8da26bcb43a4" />

- Or go to this direct link:

https://addons.mozilla.org/en-US/firefox/addon/shodan-addon/

- We see this and we also see button `add extension`

<img width="1672" height="905" alt="image" src="https://github.com/user-attachments/assets/3158f862-685e-4c25-979d-25861e714d6e" />

<img width="1640" height="622" alt="image" src="https://github.com/user-attachments/assets/9ac13563-61be-47d4-b84d-79dcf714abe7" />

- Go to some website like:
<img width="1810" height="961" alt="image" src="https://github.com/user-attachments/assets/c603225f-2e01-4349-81ac-915adab2cb47" />

in this we see `norton university` open port 80, 443, 2053, 2082, 2083, 2086, 2087, 2095, 8080, 8443, 8880. also we can view detail:

<img width="1846" height="910" alt="image" src="https://github.com/user-attachments/assets/0916dbbf-7c3e-4b14-9a85-ff287ba49256" />

We see norton use cloudflare.

<img width="1843" height="920" alt="image" src="https://github.com/user-attachments/assets/46de25ae-7151-492e-816d-80d72c106042" />

we can detail domain like this.

### ===========>> End of SHODAN

### Why Hacker use shodan:
Hackers (especially ethical ones / penetration testers) use Shodan because it gives them intelligence about targets without scanning directly:
- Reconnaissance (Info Gathering)
- Identify Vulnerable DevicesFind
