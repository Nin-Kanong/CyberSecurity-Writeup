<h1 align="center"> Recon-ng </h1>

<img width="1024" height="550" alt="Recon-ng" src="https://github.com/user-attachments/assets/3d988660-6cd5-4024-aa01-e2b7ab1a5b07" />
...
| ---------- | ------------------------------- | ----------------------------------------------------------------------------------------- |
| Recon-ng   | Information Gathering Framework | A complete, free, and open-source tool used for reconnaissance and information gathering. |
| Recon-ng   | IP Address Discovery            | Can be used to find IP addresses of a target.                                             |
| Recon-ng   | SQL Injection Detection         | Helps look for error-based SQL injection vulnerabilities.                                 |
| Recon-ng   | Sensitive File Discovery        | Can find sensitive files such as `robots.txt`.                                            |
| Recon-ng   | Geo-IP Lookup                   | Identifies the geographical location of a target IP.                                      |
| Recon-ng   | Banner Grabbing                 | Collects service banners to identify running services and versions.                       |
| Recon-ng   | DNS Lookup                      | Gathers DNS records related to a target domain.                                           |
| Recon-ng   | Port Scanning                   | Identifies open and closed ports on a target server.                                      |
| Recon-ng   | Subdomain Enumeration           | Finds subdomains of a single target domain using subdomain finder modules.                |
| Recon-ng   | Reverse IP & WHOIS              | Uses WHOIS data to find domains hosted on the same IP.                                    |
| Recon-ng   | CMS Detection                   | Detects the Content Management System (CMS) used by a target web application.             |
| Recon-ng   | Modular Design                  | Contains many modules that gather different types of target information.                  |
| InfoSploit | Information Gathering           | Used for WHOIS lookup, Geo-IP lookup, banner grabbing, DNS lookup, and port scanning.     |
| InfoSploit | Email & DNS Records             | Supports MX record lookup and subdomain information gathering.                            |
---
...
| db          | Interfaces with the workspace database                |
| exit        | Exits the Recon-ng framework                          |
| help        | Displays the help menu                                |
| index       | Creates a module index (developer use only)           |
| keys        | Manages third-party API/resource credentials          |
| marketplace | Interfaces with the module marketplace                |
| modules     | Interfaces with installed modules                     |
| options     | Manages options for the current context               |
| pdb         | Starts a Python debugger session (developer use only) |
| script      | Records and executes command scripts                  |
| shell       | Executes system shell commands                        |
| show        | Displays various framework items                      |
| snapshots   | Manages workspace snapshots                           |
| spool       | Saves (spools) output to a file                       |
| workspaces  | Manages Recon-ng workspaces                           |
