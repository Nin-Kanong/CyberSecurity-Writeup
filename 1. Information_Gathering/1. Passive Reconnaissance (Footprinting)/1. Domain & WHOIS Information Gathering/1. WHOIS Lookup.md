...
<img width="1024" height="650" alt="whois" src="https://github.com/user-attachments/assets/ae3b0571-24a2-4d70-99ee-21e6d99e3432" />
...
[Introduction to WHOIS Lookup](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#introduction-to-whois-lookup)

  - [What is WHOIS Lookup?](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#what-is-whois-lookup)
  - [A WHOIS lookup typically returns](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#a-whois-lookup-typically-returns)
  - [Whois Options](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#whois-options)

[Whois Lookup Methodology](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#whois-lookup-methodology)
  1. [WHOIS LOOKUP Commandline](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#1-whois-lookup-commandline)
     1. [Get Help](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#1-get-help)
     2. [Basic WHOIS Command Syntax](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#2-basic-whois-command-syntax)
     3. [Clean Output](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#3-clean-output)
     4. [query a specific WHOIS server](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#4-query-a-specific-whois-server)
     5. [Recursive Lookup](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#5-recursive-lookup)
     6. [Query ARIN (IP infomation)](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#6-query-arin-ip-infomation)
     7. [Check Domain Availability](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#7-check-domain-availability)
     8. [Query Directly](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#8-query-directly)
     9. [Recon use cases](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#9-recon-use-cases)
     10. [Automate WHOIS Queries with Bash Script](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#10-automate-whois-queries-with-bash-script)
     11. [Parse WHOIS Output with grep, awk, cut](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#11-parse-whois-output-with-grep-awk-cut)
     12. [Using WHOIS in Python](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#12-using-whois-in-python)  
  2. [Use Browser](https://github.com/Nin-Kanong/pentest-writeups/blob/main/1.%20Information_Gathering/1.%20Passive%20Reconnaissance%20(Footprinting)/1.%20Domain%20%26%20WHOIS%20Information%20Gathering/1.%20WHOIS%20Lookup.md#use-browser)
...
| ------------------------ | ------------------------------------------------------------- |
| `-h HOST`, `--host HOST` | Connect to a specific WHOIS server (`HOST`).                  |
| `-p PORT`, `--port PORT` | Connect to a specific port (`PORT`).                          |
| `-I`                     | Query `whois.iana.org` and follow its referral automatically. |
| `-H`                     | Hide legal disclaimers in the output.                         |
| `--verbose`              | Explain what is being done (show detailed actions).           |
...
| **Option / Flag**       | **Description**                                                   |         |                                                     |
| ----------------------- | ----------------------------------------------------------------- | ------- | --------------------------------------------------- |
| `-l`                    | Find one level less specific match.                               |         |                                                     |
| `-L`                    | Find all levels less specific matches.                            |         |                                                     |
| `-m`                    | Find all one level more specific matches.                         |         |                                                     |
| `-M`                    | Find all levels of more specific matches.                         |         |                                                     |
| `-c`                    | Find the smallest match containing a `mnt-irt` attribute.         |         |                                                     |
| `-x`                    | Exact match only.                                                 |         |                                                     |
| `-b`                    | Return brief IP address ranges with abuse contact info.           |         |                                                     |
| `-B`                    | Turn off object filtering (show email addresses).                 |         |                                                     |
| `-G`                    | Turn off grouping of associated objects.                          |         |                                                     |
| `-d`                    | Return DNS reverse delegation objects too.                        |         |                                                     |
| `-i ATTR[,ATTR]...`     | Perform inverse look-up for specified attributes.                 |         |                                                     |
| `-T TYPE[,TYPE]...`     | Only look for objects of a specified type.                        |         |                                                     |
| `-K`                    | Return only primary keys.                                         |         |                                                     |
| `-r`                    | Turn off recursive look-ups for contact information.              |         |                                                     |
| `-R`                    | Show local copy of domain object even if it contains referral.    |         |                                                     |
| `-a`                    | Also search all mirrored databases.                               |         |                                                     |
| `-s SOURCE[,SOURCE]...` | Search the database mirrored from specific source(s).             |         |                                                     |
| `-g SOURCE:FIRST-LAST`  | Find updates from a source between serial numbers FIRST and LAST. |         |                                                     |
| `-t TYPE`               | Request template for object of specified type.                    |         |                                                     |
| `-v TYPE`               | Request verbose template for object of specified type.            |         |                                                     |


---


# Whois Lookup Methodology 

## 1. WHOIS LOOKUP Commandline
...
Forces query to Google’s registrar server. 
...
<h2 align="center"> Finished of Whois Lookup </h2>
...
<p align="center">
  &copy; 2025 Nin Kanong (<a href="https://github.com/Nin-Kanong/pentest-writeups">Nin Kanong (k4n0ng) /a>). All rights reserved.
</p>
